%% C++ Enum Converted to Matlab, with help from ChatGPT
%
% Access Values like this: "ODriveEnums.GpioMode.GPIO_MODE_DIGITAL"
% 

% ODrive.GpioMode
ODriveGpioMode = struct('GPIO_MODE_DIGITAL', 0, ...
...
ODriveStreamProtocolType = struct('STREAM_PROTOCOL_TYPE_FIBRE', 0, ...
...
% ODrive.Can.Protocol
ODriveProtocol = struct('PROTOCOL_NONE', 0x00000000, ...
                        'PROTOCOL_SIMPLE', 0x00000001);

% ODrive.Axis.AxisState
ODriveAxisState = struct('AXIS_STATE_UNDEFINED', 0, ...
                        'AXIS_STATE_IDLE', 1, ...
...
ODriveControlMode = struct('CONTROL_MODE_VOLTAGE_CONTROL', 0, ...
                            'CONTROL_MODE_TORQUE_CONTROL', 1, ...
                            'CONTROL_MODE_VELOCITY_CONTROL', 2, ...
                            'CONTROL_MODE_POSITION_CONTROL', 3);

% ODrive.ComponentStatus
ODriveComponentStatus = struct('COMPONENT_STATUS_NOMINAL', 0, ...
...
% ODrive.Error
ODriveError = struct('ODRIVE_ERROR_NONE', 0x00000000, ...
...
ODriveProcedureResult = struct('PROCEDURE_RESULT_SUCCESS', 0, ...
...
% ODrive.EncoderId
ODriveEncoderId = struct('ENCODER_ID_NONE', 0, ...
...
ODriveSpiEncoderMode = struct('SPI_ENCODER_MODE_DISABLED', 0, ...
...
ODriveRs485EncoderMode = struct('RS485_ENCODER_MODE_DISABLED', 0, ...
...
ODriveInputMode = struct('INPUT_MODE_INACTIVE', 0, ...
...
% ODrive.MotorType
ODriveMotorType = struct('MOTOR_TYPE_HIGH_CURRENT', 0, ...
                        'MOTOR_TYPE_GIMBAL', 2, ...
                        'MOTOR_TYPE_ACIM', 3);

% ODrive.Can.Error
ODriveCanError = struct('CAN_ERROR_NONE', 0x00000000, ...
...
ODriveEnums = struct('GpioMode', ODriveGpioMode, ...
                    'StreamProtocolType', ODriveStreamProtocolType, ...
                    'Protocol', ODriveProtocol, ...
                    'AxisState', ODriveAxisState, ...
                    'ControlMode', ODriveControlMode, ...
                    'ComponentStatus', ODriveComponentStatus, ...
                    'Error', ODriveError, ...
                    'ProcedureResult', ODriveProcedureResult, ...
                    'EncoderId', ODriveEncoderId, ...
                    'SpiEncoderMode', ODriveSpiEncoderMode, ...
                    'Rs485EncoderMode', ODriveRs485EncoderMode, ...
                    'InputMode', ODriveInputMode, ...
                    'MotorType', ODriveMotorType, ...
                    'CanError', ODriveCanError);

% Save the struct to a .mat file if needed
save('ODriveEnums.mat', 'ODriveEnums');
